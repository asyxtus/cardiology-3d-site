    ...
    <footer className="relative border-t border-white/10 bg-slate-950/95 py-10 text-slate-300">
      ...
      <div className="relative mx-auto flex max-w-6xl flex-col gap-8 px-4 lg:flex-row lg:items-start lg:justify-between lg:px-8">
        ...
        >
          ...
          <p className="max-w-md text-sm text-slate-400">
            Preventive cardiology, early diagnosis and calm follow up care for
            your heart and vascular health at Total Care Medical Clinic.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <p className="text-slate-400">
              {/* Replace with your actual area / street if you want */}
        ...
        >
          ...
          <p>
            This website is for information and appointment requests only. It
            does not replace emergency medical care.
          </p>
          <p>
            If you have chest pain, shortness of breath, severe dizziness or
            fainting, please go to the nearest emergency department or call your
      ...
      <div className="mt-8 border-t border-white/5 pt-4">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-3 px-4 text-[0.7rem] text-slate-500 sm:flex-row lg:px-8">
          <p>© {new Date().getFullYear()} Asah Syxtus. All rights reserved.</p>
          <p>Designed and built by Asah Syxtus in Douala.</p>
        </div>
      </div>
    </footer>
  );
